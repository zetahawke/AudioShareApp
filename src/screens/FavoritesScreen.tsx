...
const FavoritesScreen: React.FC = () => {
  const { favorites, loadAudioFiles, toggleFavorite, incrementPlayCount, incrementShareCount, isLoading } = useAudio();
    ...
    return (
      <View style={styles.emptyContainer}>
        ...
        <Text style={styles.emptySubtitle}>
          Start adding audio files to your favorites to see them here
        </Text>
      </View>
    );
  }
    ...
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerSubtitle}>
          {favorites.length} audio file{favorites.length !== 1 ? 's' : ''} in your collection
        </Text>
      </View>
